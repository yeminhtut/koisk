...
import ToshibaIcon from "../assets/icons/logo-white.png";
...
export default function CustomDemo() {
    ...
    const endContent = (
        <React.Fragment>
            <div className="flex align-items-center gap-2">
                <span className="font-bold text-bluegray-50">Y</span>
    ...
    return (
        <div className="card">
            <Toolbar start={startContent} center={centerContent} end={endContent} className="taskbar shadow-2 border-noround border-none" style={{ backgroundColor: '#2E3643' }} />
        </div>
    );
}
