...
const ConfirmOrder = () => {
    ...
    const getCartBySession = async () => {
        try {
            const response = await axios.get(`${URL}/pos/v1/cart/${cartid}/${orderid}?&status=sales`, {
                headers: {
                    Authorization: 'test',
    ...
    const handlePayment = async () => {
        try {
            ...
            const response = await axios.post(`${URL}/pos/v1/cart/${cartid}/payment`, JSON.stringify(data), {
                headers: {
                    Authorization: 'test',
                    'Content-Type': 'application/json',
                },
    ...
    const handleCloseCart = async () => {
        try {
            ...
            const response = await axios.put(`${URL}/pos/v1/cart/${cartid}/close`, JSON.stringify(data), {
                headers: {
                    Authorization: 'test',
                    'Content-Type': 'application/json',
                },
            ...
            console.log('Cart closed successfully:', response.data);
    ...
    return (
        <div className="p-4" style={{ maxWidth: '768px', margin: '0 auto' }}>
            <div className="flex align-items-center justify-content-between mb-4">
                ...
                <h2>Confirm Order</h2>
                <button className="p-button p-button-text">Clear</button>
            </div>
